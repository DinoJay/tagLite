...
import colaLayout from "./colaFoci2.js";
...
function createSubGraph(c){
  ...
  var simulation = d3.forceSimulation(c.nodes)
...
function update(cola) {
  ...
  var nodeCont = compEnter
    .append("g")
    .each(createSubGraph);
  console.log("nodecont", nodeCont);
